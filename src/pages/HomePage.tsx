...
export const HomePage: React.FC = () => {
  ...
  return (
    <div className="space-y-16 pb-16 animate-fadeIn">
      {/* Top Editorial Announcement & Live Rolling Ticker (Nature + IJCA style) */}
      <div className="bg-[var(--bg-card)] border-b border-[var(--border-subtle)] py-2.5 px-4 text-xs">
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-3 text-[var(--text-secondary)]">
          <div className="flex items-center gap-2.5 truncate max-w-4xl">
            <span className="px-2 py-0.5 rounded font-mono text-[10px] font-bold bg-[var(--accent-crimson)] text-white uppercase tracking-wider shrink-0 flex items-center gap-1 shadow-2xs">
              <Activity className="w-3 h-3 animate-pulse" /> Live Wire
            </span>
            <Link to="/article/e2026-0492" className="hover:text-[var(--accent-navy)] truncate flex items-center gap-1.5 font-medium">
              <span className="font-mono text-[var(--accent-gold)] font-bold">[Art. e10492]</span>
              <span className="truncate">The Rashomon Paradigm in Indian Criminal Jurisprudence: Reconciling Algorithmic Forensics with Article 21 and the BSA (2023)</span>
            </Link>
          </div>
          <div className="flex items-center gap-3 text-[11px] font-mono text-[var(--text-muted)] shrink-0 ml-auto">
            <a href="#cfp" className="flex items-center gap-1 text-emerald-600 dark:text-emerald-400 font-semibold hover:underline">
              <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse"></span>
              <span>CFP Vol. 1(2) Open</span>
            </a>
            <span className="text-[var(--border-strong)]">•</span>
            <span>Vol. 1 (2026) Continuous Publication</span>
            <span className="text-[var(--border-strong)]">•</span>
            <Link to="/aims-scope" className="font-sans font-semibold text-[var(--accent-navy)] hover:underline flex items-center gap-1">
